function  [I1r, I2r, bb1, bb2, Pn1, Pn2]  = rectify(img_file1, img_file2, varargin)
    ...
    if opts.calibrated && exist([a1,'/',b1,'.pm'],'file') == 2  &&...
        ...
        %% vl_setup and saved the path
        % comment these lines (and l. 46 as well) if you already run it
        oldpath = path;
        addpath('/Users/liujiaoyang/Documents/MATLAB/Three_Dimensional_Reconstruction/vlfeat-0.9.21/toolbox');
        vl_setup
